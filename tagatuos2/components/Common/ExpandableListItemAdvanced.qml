            ...
            function getItems(selectedOnly) {
                ...
                for (var i = 0; i <= model.count - 1; i++) {
                    ...
                    if (selectedOnly) {
                        ...
                        if (i >= 1) {
                            //                            console.log("itemSelected: " + i + " - "+ expandableList.contentItem.children[i + 1])
                            if (expandableList.contentItem.children[i + 1] !== undefined) {
                                itemSelected = expandableList.contentItem.children[i + 1].selected
                            }
                            //                            console.log("itemSelected: " + i + " - "+ itemSelected)
                        } else {
                            //                            console.log("itemSelected: " + i + " - "+ expandableList.contentItem.children[i])
