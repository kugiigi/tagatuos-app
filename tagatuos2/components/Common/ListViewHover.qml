...
MouseArea {
    ...
    Component {
        ...
        ListViewHighlight {
            id: highlightRec
            color: alreadyHighlighted ? "transparent" : "#1A371300"
                ...
                Row {
                    ...
                    anchors {
                        ...
                        top: actionsPosition.search("Top") === -1 ? undefined : parent.top
                        right: actionsPosition.search("Right") === -1 ? undefined : parent.right
                        rightMargin: units.gu(3)
                        verticalCenter: actionsPosition.search("Middle") === -1 ? undefined : parent.verticalCenter
                        left: actionsPosition.search("Left") === -1 ? undefined : parent.left
                        leftMargin: units.gu(3)
                        bottom: actionsPosition.search("Bottom") === -1 ? undefined :parent.bottom
