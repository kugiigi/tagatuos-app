...
UBUNTU_TRANSLATION_DOMAIN="tagatuos2.kugiigi"
...
aptest.commands = bash $$PWD/tagatuos2/tests/autopilot/run
aptest.depends  = sub-tagatuos2

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/tagatuos2/tests/unit
